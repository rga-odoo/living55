...
class sale_order(models.Model):
    ...
    #     if record.auto_workflow_process_id:
    #         if record.auto_workflow_process_id.validate_order:
    #             record.action_confirm()

    #         if record.auto_workflow_process_id.create_invoice:
    #             record.action_invoice_create()
    #         if record.auto_workflow_process_id.validate_invoice:
    #             print ("validate invoice")
    #         if record.auto_workflow_process_id.register_payment:
    #             print ("Register Payment")
    #         if record.auto_workflow_process_id.invoice_date_is_order_date:
    #             print ("Forced Invoice Date")
    #     return record
